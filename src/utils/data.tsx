      ...
      },
      {
        ...
        history: [
          ...
          },
          {
            moji: 'シルクロード',
            yomi: 'しるくろーど',
            mean: '中央アジアを通る、主に絹を運搬していた道',
          },
          {
            moji: '万里の長城',
            yomi: 'ばんりのちょうじょう',
            mean: '秦の始皇帝が建てた、遊牧移民の侵入を防ぐための城壁',
          },
          {
            moji: '都市国家',
            yomi: 'としこっか',
          ...
          },
          {
            moji: 'ハンムラビ法典',
            yomi: 'はんむらびほうてん',
            mean: 'メソポタミア地域で用いられた法律(ルール)',
          },
          {
            moji: 'アレクサンドロス大王',
            yomi: 'あれくさんどろすだいおう',
            mean: 'マケドニアの王で、東方遠征をおこなった人物',
          },
          {
            moji: 'ヘレニズム文化',
            yomi: 'へれにずむぶんか',
          ...
          },
          {
            moji: 'キリスト教',
            yomi: 'きりすときょう',
            mean: 'イエスがパレスチナで開いた宗教',
          },
          {
            moji: 'イスラム教',
            yomi: 'いすらむきょう',
            mean: 'ムハンマドがアラビア半島で開いた宗教',
          },
          {
            moji: '三大宗教',
            yomi: 'さんだいしゅうきょう',
            mean: '仏教、キリスト教、イスラム教の総称',
          },
          {
            moji: '新約聖書',
            yomi: 'しんやくせいしょ',
          ...
          },
          {
            moji: '土偶',
            yomi: 'どぐう',
            mean: '縄文時代の、女性の形をした人形',
          },
          {
            moji: 'カーバ神殿',
            yomi: 'かーばしんでん',
            mean: 'メッカに位置する、イスラム最高の聖地',
          },
          {
            moji: '邪馬台国',
            yomi: 'やまたいこく',
            mean: '魏志倭人伝に書かれている、弥生時代に存在されていたとする国',
          },
          {
            moji: '卑弥呼',
            yomi: 'ひみこ',
